# Quality Standard — Noninvasive Disease Risk Predictor
...
| Area | Value |
| --- | --- |
| Detected stack | Node.js, AI/ML |
| Primary language | JavaScript |
| Topics | analytics-dashboard, final-year-project, healthcare, javascript, machine-learning, risk-prediction, web-app |
